...
document.write("<script language='javascript' src='/highcharts/js/jquery-3.3.1.min.js'></script>");//引入Jquery(1.8.0以上版本)
document.write("<script language='javascript' src='/highcharts/js/highcharts.js'></script>"); //引入hightcharts引擎
document.write("<script language='javascript' src='/highcharts/js/exporting.js'></script>"); //引入hightcharts引擎
document.write("<script language='javascript' src='/highcharts/js/highcharts-more.js'></script>"); //引入hightcharts引擎
